 ...
 * - For wallet: import { useWalletAuthentication } from '@/features/wallet/hooks/useWalletAuthentication'
 * - For OAuth: import { useOAuthAuthentication } from '@/features/oauth/hooks/useOAuthAuthentication'
 */

import { registerProtectionProvider } from '@/features/auth/registry/protectionRegistry';
import { oauthProtectionProvider } from '@/features/oauth/authProvider';
