...
import { store } from '@/core/features/app/store/store';
import { Router } from '@/core/features/router/Router';

import '@/core/features/i18n/i18n';

// Register auth providers (composition root)
import '@/config/core/auth/auth';
