  ...
  return (
    <>
      ...
      <Stack gap="md">
        ...
        <Text>
          {t('This page demonstrates basic Web3 wallet authentication using MetaMask, Coinbase Wallet, Core, or Rabby.')}
        </Text>
        {withWalletProtection(
          <Alert title={t('Wallet Connected!')} color="green">
            {t('You have successfully connected your wallet. This content is only visible to authenticated wallet users.')}
          </Alert>,
          <Alert title={t('Wallet Required')} icon={<IoIosWarning />}>
            {t('Please connect your wallet to view the protected content on this page.')}
          </Alert>
        )}
        <Text c="dimmed" size="sm">
          {t('This demonstrates the withWalletProtection HOC pattern for conditional rendering.')}
        </Text>
      </Stack>
    </>
  );
